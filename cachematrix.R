...
##This program explores one of the ways to perform this caching.

# makeCacheMatrix creates a list containing a function to
# set and get the value of a matrix
# set and get the value of inverse of the original matrix
...
##Note: Assumption the matrix is always invertible.
